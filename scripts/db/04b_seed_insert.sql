-- ============================================================
-- 04b_seed_insert.sql  — Solo INSERTs con INSERT IGNORE
-- ============================================================

SET FOREIGN_KEY_CHECKS = 0;

-- CLIENTES
INSERT IGNORE INTO clients (id, tenant_id, name, email, phone, status, plan, plan_end, photo, weight, height, bmi, join_date, visits, visits_remaining) VALUES
...
-- PRODUCTOS
INSERT IGNORE INTO products (id, tenant_id, name, category, price, stock, emoji, description, rating, sold) VALUES
...
-- EQUIPAMIENTO
INSERT IGNORE INTO equipment (id, tenant_id, name, type, quantity, status, location, notes) VALUES
...
-- PAGOS
INSERT IGNORE INTO payments (id, tenant_id, client_id, client_name, concept, amount, method, discount, promo, date) VALUES
...
-- VENTAS
INSERT IGNORE INTO sales (id, tenant_id, client_name, total, method, date) VALUES
...
INSERT IGNORE INTO sale_items (sale_id, name, qty, price) VALUES
...
-- PROMOCIONES
INSERT IGNORE INTO promotions (id, tenant_id, name, type, value, active, applies_to, description) VALUES
...
-- ASISTENCIAS
INSERT IGNORE INTO attendance (id, tenant_id, client_id, client_name, date, checkin, checkout, duration, status) VALUES
...
-- RUTINAS
INSERT IGNORE INTO routines (id, tenant_id, name, level, description) VALUES
...
INSERT IGNORE INTO routine_exercises (routine_id, description, sort_order) VALUES
(1, 'Sentadillas 4x12',         1), (1, 'Press banca 4x10',         2),
(1, 'Peso muerto rumano 3x10',  3), (1, 'Remo con barra 3x12',      4),
(2, 'Press inclinado 4x8',      1), (2, 'Dominadas 4x8',            2),
(2, 'Curl bíceps 3x12',         3), (2, 'Extensiones tríceps 3x12', 4),
